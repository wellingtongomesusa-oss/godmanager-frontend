...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brex-bg px-4">
      <Card className="w-full max-w-md shadow-brex-xl">
        <CardHeader className="text-center">
          <div className="mx-auto mb-4">
            <Logo size="lg" />
          </div>
          <CardTitle className="text-2xl text-brex-black">Dashboard Godroox</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="usuario" className="mb-2 block text-sm font-medium text-brex-black">
                Usuário master
              </label>
              <input
                id="usuario"
                ...
                className="flex h-10 w-full rounded-brex border border-secondary-200 bg-white px-3.5 py-2 text-sm text-brex-black placeholder:text-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500"
                autoComplete="username"
              />
            </div>
            <div>
              <label htmlFor="senha" className="mb-2 block text-sm font-medium text-brex-black">
                Senha master
              </label>
              <input
                id="senha"
