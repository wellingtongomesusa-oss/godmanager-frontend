...
import { SecurityContent } from '@/components/legal/security/SecurityContent';
...
export default async function SecurityPage({ params: { locale } }: PageProps) {
  setRequestLocale(locale);
  ...
  return (
    <LegalPageLayout>
      ...
      <LegalArticle>
        <SecurityContent locale={appLocale} />
      </LegalArticle>
    </LegalPageLayout>
  );
}
